#!/usr/bin/env python3
"""
Legacy Flask-based MCP server for image generation.

This is the original implementation using Flask directly, maintained for backward compatibility.
For new deployments, consider using the fastMCP implementation in the package.
"""
